...
* [2023-3-30 Thu] - running smooth on is 
** tried running new baseline, actually ran elevated k+ 
** k+ sim looked similar to prev w/ higher o2 drive 

* [2023-3-31 Fri] - SD sims running 
** running 10s elevated k+ sim on is
** made figure for SD from elevated K+ 
*** added to thesis, posted to rxd, need to update in manuscript 
** running 2s test version of ouabain sim on is
*** if looks ok, try 10s 

* [2023-4-3 Mon] - 20s of SD
** 20s sim very interesting
*** SD travels to all cortical layers (start in L4, then L2/3, then 5/6)
*** K+ wave is does not just diffuse radially - high activity in L2/3 initiates 
a seconds K+ wave 
*** should consider running for 30s in case 
*** could try startin SD in 2/3 to see if jumps to 5
** ouabain didn't produce SD within 2s, should try 10s 

* [2023-4-25 Tue] - back into sd 
** trying ischemia (no o2 drive)

* [2023-4-27 Thu] - iscemia sim
** SD from ischemic insult 
*** [[PDCM_RxD/Data/conn1.6e-6_pois0.2_o2none_13kpmm_1mm3_dx50_20s/][standard params, but no o2 sources]]

* [2023-4-28 Fri] - long baseline, ischem 
** baseline sim still running 

* [2023-5-1 Mon] - SD for baseline 
** long baseline with SD 
[[PDCM_RxD/Data/conn1.6e-6_pois0.2_o20.13_13kpmm_1mm3_dx50_20s/][20s no insult but get SD]]
*** still get SD, just delayed by ~1/2 second compared to ischemic sim 
** trying no boundary conditions / reflective boundary conditions to remedy 

* [2023-5-2 Tue] - working on baseline 
** reflective boundary conditions didn't produce SD within 5s, but was coming in L2 
** trying [o2]=0.08 per bill's suggestion and reflective bc 

* [2023-5-3 Wed] - increasing o2 to 0.08 
** still get start of SD in L2 
* TODOS
** DONE: fix titles of videos 
** DONE: redo video w/ different vmax/mins 
** DONE: run long baseline
** TODO: get on stampede 
*** tried idev, got *ERROR: You have no project in the projectuser.map file (in accounting_check_prod.pl).*
** DONE: new baseline based off initK.py 
** TODO: plotting fragmented runs needs to ignore repeated data 
** DONE: rerun baseline (actually was k=40)
...
** DONE: fix mp4 
** DONE: rescalability of rxd version of PD model
...
** DONE: check out bluepyopt
*** adam working on biophysical version of PD model 
