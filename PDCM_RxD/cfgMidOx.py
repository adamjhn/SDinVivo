...
cfg.saveFolder = "/tmp/testrun"  # f'/vast/palmer/scratch/mcdougal/ajn48/{cfg.simLabel}'
...
cfg.seed = 120194
cfg.restoredir = (
    False  # cfg.saveFolder #'Data/k0_conn1.6e-6_pois0.2_o20.13_13kpmm_1mm3_dx50_10s/'
)
