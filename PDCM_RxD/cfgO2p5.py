...
cfg.duration = 7e3        # Duration of the simulation, in ms
...
cfg.filename = exp_dir + 'O2drive1.0_conn1.6e-6_pois0.2_ThT_13kpmm_dx50_6.5-7s/'   # Set file output name
...
cfg.seed = 120194
cfg.restoredir = exp_dir + 'O2drive1.0_conn1.6e-6_pois0.2_ThT_13kpmm_dx50_5-10s/'
