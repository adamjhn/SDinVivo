...
#             'delay': 0.5,
#             'synMech' : 'exc'} # 1 delay
netParams.stimSourceParams['Ebkg1'] = {'type': 'NetStim', 'rate': 4, 'noise': 0.3, 'start' : 0}
netParams.stimTargetParams['bkg->E1'] = {'source': 'Ebkg1', 'conds': {'pop': L}, 'weight': 0.5, 'delay': 1, 'synMech': 'exc'}
